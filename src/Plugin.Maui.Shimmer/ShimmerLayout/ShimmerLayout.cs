using Mafiator.Game.Controls.ShimmerLayout.Extensions;
using Mafiator.Game.Controls.ShimmerLayout.Models.SkiaHelpers;
using SkiaSharp;
using SkiaSharp.Views.Maui;

namespace Mafiator.Game.Controls.ShimmerLayout;
...
public class ShimmerLayout : Grid
{
    ...
    private const string _shimmerAnimation = "ShimmerAnimation";
    ...
    public static void Init(double deviceDensity) => _density = deviceDensity;
        ...
        var tasks = new[]
        {
            ...
            Task.Run(async () =>
            {
                ...
                while (!_animationCancellationTokenSource.Token.IsCancellationRequested)
                {
                    ...
                    }.Commit(_maskCanvasView, _shimmerAnimation, 16, Duration, Easing.Linear,
    ...
    private void CancelAnimation()
    {
        ...
        _maskCanvasView?.AbortAnimation(_shimmerAnimation);
    }
    ...
    private void RemoveShimmer()
    {
        ...
        Task.Run(async () =>
        {
            ...
            Dispatcher.Dispatch(() => _maskCanvasView.IsVisible = false);
        });
    }
    ...
    private void ExtractVisualElements(View baseElement)
    {
        ...
        if (baseElement is not Layout baseLayout)
        {
        ...
        baseLayout
            .ToSKLayout()
            .GetChildrenSKVisualElements().ToList()
